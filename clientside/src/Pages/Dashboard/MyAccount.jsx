...
const DepositsIcon = () => (
  ...
  >
    <path
      fill="currentColor"
      d="M12 24c5.119 0 9.061-3.942 9.061-9.06S17.119 5.88 12 5.88c-5.117 0-9.059 3.942-9.059 9.06S6.883 24 12 24m0-5.598c-1.954 0-3.461-1.508-3.461-3.462s1.507-3.462 3.461-3.462c1.955 0 3.462 1.507 3.462 3.462c0 1.954-1.507 3.462-3.462 3.462m2.634-12.241h6.161V0h-6.161z"
    />
  </svg>
);
...
const EarningsIcon = () => (
  ...
  >
    <g fill="currentColor">
      <path d="M11.9 19.52v-7.64h1.66v7.64zm3.31 0v-7.64h1.69v7.64zm3.35 0v-7.64h1.62v7.64z" />
      <path d="M16 27c6.075 0 11-4.925 11-11S22.075 5 16 5S5 9.925 5 16s4.925 11 11 11m6.73-5.86c.11.35-.15.7-.5.71H9.78c-.35 0-.61-.34-.51-.68l.35-1.25c.06-.23.27-.39.51-.39h.11v-7.77c-.42-.28-.5-.97.02-1.28l5.4-3.26c.24-.15.54-.15.78 0l5.39 3.26c.52.31.44 1 .01 1.28v7.76h-.03c.23 0 .44.15.51.37z" />
      <path d="M16 1C7.716 1 1 7.716 1 16c0 8.284 6.716 15 15 15c8.284 0 15-6.716 15-15c0-8.284-6.716-15-15-15M3 16C3 8.82 8.82 3 16 3s13 5.82 13 13s-5.82 13-13 13S3 23.18 3 16" />
    </g>
  </svg>
);
  ...
  return (
    <div>
      ...
      <div className="sm:ml-64 sm:p-4 mb-16">
        <div className="flex items-center gap-2 mx-2 mt-20 font-semibold">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="w-6 h-6"
            viewBox="0 0 24 24"
