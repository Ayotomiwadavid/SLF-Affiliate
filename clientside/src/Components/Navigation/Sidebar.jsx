  ...
  const sidebarItems = [
    {
      ...
      icon: (
        <svg
          className="flex-shrink-0 w-6 h-6 text-pink-500 transition duration-75  group-hover:text-gray-900 dark:group-hover:text-white"
  ...
  return (
    ...
    >
      <div className="h-full px-3 pb-4 overflow-y-auto bg-white">
        ...
        <button
          className="flex w-full mt-9 items-center p-2 text-xl text-gray-900 rounded-lg hover:bg-purple-200 dark:hover:bg-purple-700 group font-medium"
        ...
        <div
          id="dropdown-cta"
          className="p-4 mt-6 rounded-lg bg-pink-100 "
          role="alert"
        >
