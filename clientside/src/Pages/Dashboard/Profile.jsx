...
const Profile = () => {
    return (
        <div>
            <DashboardLayout />
            <div className="min-h-screen sm:ml-64 pt-20 bg-gray-100 py-10">
                <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
                    <div className="bg-cover bg-center h-56" style={{ backgroundImage: "url('https://flowbite.com/docs/images/people/profile-picture-5.jpg')" }}></div>
                    <div className="p-8">
                        <div className="relative flex items-center">
                            <div className="w-24 h-24 bg-white rounded-full border-4 border-white absolute -top-12 left-1/2 transform -translate-x-1/2">
