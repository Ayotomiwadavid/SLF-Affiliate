    ...
    return (
        <div className="w-full max-w-sm">
            <div className="mb-2 flex justify-between items-center">
                <label htmlFor="url-shortener" className="text-sm font-medium text-gray-900 dark:text-white">Shorten URL:</label>
            </div>
            <div className="flex items-center gap-2">
                ...
                <div className="relative w-full">
                    <input id="url-shortener" type="text" className="bg-gray-50 border border-gray-300 text-gray-500 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" value={referralLink} readOnly disabled />
                </div>
                <button onClick={copyToClipboard} className="flex-shrink-0 z-10 inline-flex items-center py-3 px-4 text-sm font-medium text-center text-gray-500 dark:text-gray-400 hover:text-gray-900 bg-purple-600 border border-gray-300 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100" type="button">
                    <span id={iconState}>
            ...
            <p id="helper-text-explanation" className="mt-2 text-sm text-gray-500 dark:text-gray-400">Make sure that your URL is valid</p>
        </div>
    );
};
